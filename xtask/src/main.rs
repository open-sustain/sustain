...
//!   placeholder and header validity, fuzzy/untranslated/obsolete entries,
//!   missed call shapes).
//! - `i18n-compile` — build the installable `.mo`, desktop, and AppStream
//!   artifacts under `target/i18n/`.
...
Commands:
  ...
  i18n-compile   Build .mo, desktop, and AppStream artifacts under target/i18n/";
